...
export const FingerprintIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M2 12C2 6.5 6.5 2 12 2a10 10 0 0 1 8 6"/><path d="M5 15.126A10 10 0 0 1 5 12a7 7 0 0 1 7-7 7 7 0 0 1 7 7v2.5"/><path d="M8 10.539a4 4 0 0 1 8 0"/><path d="M10 12v.5a2 2 0 0 0 4 0V12a4 4 0 0 0-8 0v2.5a2.5 2.5 0 1 0 5 0v-1.5"/></svg>
);
...
export const PiggyBankIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M19 5c-1.5 0-2.8 1.4-3 2-3.5-1.5-11-.3-11 5 0 1.8 0 3 2 4.5V20h4v-2h3v2h4v-4c1-.5 1.7-1 2-2.5V5z"/><line x1="2" y1="9" x2="7" y2="9"/><circle cx="16" cy="11" r="1"/></svg>
);

export const LogoTooth: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M4.2 11c2 0 2.5-1 3.8-1s2.8 2 4 2 2.5-2 4-2 1.8 1 3.8 1c1.2 0 2.2-.8 2.2-2 0-1-.8-2.2-2-2.2-2 0-2.5 1-3.8 1s-2.8-2-4-2-2.5 2-4 2-1.8-1-3.8-1C3.2 7 2.2 7.8 2.2 9c0 1 .8 2.2 2 2.2Z"/><path d="M4.2 13c2 0 2.5 1 3.8 1s2.8-2 4-2 2.5 2 4 2 1.8-1 3.8-1c1.2 0 2.2.8 2.2 2 0 1-.8 2.2-2 2.2-2 0-2.5-1-3.8-1s-2.8 2-4 2-2.5-2-4-2-1.8 1-3.8 1C3.2 17 2.2 16.2 2.2 15c0-1 .8-2.2 2-2.2Z"/></svg>
);

export const LogoMedical: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 2v20"/><path d="M2 12h20"/></svg>
);

export const LogoShield: React.FC<IconProps> = ({ className }) => (
